...
# 카카오 미러 서버 설정
sed -i 's/http:\/\/archive.ubuntu.com/http:\/\/ftp.kaist.ac.kr/g' /etc/apt/sources.list && \
sed -i 's/http:\/\/security.ubuntu.com/http:\/\/ftp.kaist.ac.kr/g' /etc/apt/sources.list && \
